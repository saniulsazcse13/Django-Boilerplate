...
export default function SettingsPage() {
  ...
  const handleSave = () => {
    toast({ title: "Settings saved", description: "Your changes have been updated.", variant: "success" })
  }
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                { title: "Push Notifications", desc: "Receive push notifications in browser" },
                { title: "Weekly Digest", desc: "Receive a weekly summary of activity" },
